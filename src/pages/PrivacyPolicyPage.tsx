export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-white text-purpleTextDark font-sans px-6 py-16 max-w-4xl mx-auto">
      ...
      <p className="text-lg mb-6 text-center max-w-xl mx-auto">
        ...
        vieta vaikams žaisti ir mokytis. Čia mes labai rūpinamės tavo privatumu
        ir saugumu!
      </p>
      ...
      <section className="mb-10 p-6 bg-purpleLight rounded-lg shadow-md">
        ...
        <p>
          Mes nerenkame jokios tavo asmeninės informacijos. Visi žaidimai veikia
          tiesiog tavo naršyklėje – be prisijungimų ir registracijų!
        </p>
      </section>
      ...
      <section className="mb-10 p-6 bg-purpleLight rounded-lg shadow-md">
        ...
        <p>
          Šioje svetainėje nėra reklamų, slapukų ar kitų įrankių, kurie stebėtų
          tavo veiklą. Tu esi saugus!
        </p>
      </section>
      ...
      <section className="mb-10 p-6 bg-purpleLight rounded-lg shadow-md">
        ...
        <p>
          Tėveliai, jei turite klausimų apie privatumo taisykles, rašykite mums
          el. paštu:{" "}
          <a
      ...
      <section className="mb-10 p-6 bg-purpleLight rounded-lg shadow-md">
        ...
        <p>
          Privatumo politika gali būti keičiamasi bet kada, kai pridedame naujų
          žaidimų ar funkcijų. Sekite naujienas ir būkite ramūs!
        </p>
      </section>
